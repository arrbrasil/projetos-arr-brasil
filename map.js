...
fetch('brazil-states.geo.json?v=10').then(r=>r.json()).then(data=>{MAP_DATA=data;renderMap(MAP_ROWS)}).catch(()=>$('brazilMap').innerHTML='<p>Não foi possível carregar a malha estadual.</p>');
